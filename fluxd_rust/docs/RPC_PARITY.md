...
- zgettotalbalance - Partial (Sapling only for private balance; scans chain for Sapling notes; supports watch-only via includeWatchonly)
...
- zlistoperationids - Implemented (returns an empty array; async shielded ops not implemented yet)
